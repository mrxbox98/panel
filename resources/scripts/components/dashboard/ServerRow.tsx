                ...
                {(!stats || isSuspended) ?
                    ...
                    <React.Fragment>
                        <div css={tw`flex-1 ml-4 sm:block hidden`}>
                            ...
                            <p css={tw`text-xs text-neutral-200 text-center mt-1`}>of {cpuLimit}</p>
                        </div>
                        <div css={tw`flex-1 ml-4 sm:block hidden`}>
                            <div css={tw`flex justify-center`}>
                            ...
                            <p css={tw`text-xs text-neutral-200 text-center mt-1`}>of {memoryLimit}</p>
                        </div>
                        <div css={tw`flex-1 ml-4 sm:block hidden`}>
                            <div css={tw`flex justify-center`}>
                            ...
                            <p css={tw`text-xs text-neutral-200 text-center mt-1`}>of {diskLimit}</p>
                        </div>
                    </React.Fragment>
                }
            </div>
